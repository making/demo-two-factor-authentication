...
import static com.example.twofactorauth.TwoFactorAuthorizationManager.passwordToken;
...
public class SignupController {
	...
	public String signup(SignupForm form) {
		...
		SecurityContextHolder.getContext().setAuthentication(passwordToken(userDetails));
		return "redirect:/";
	}
